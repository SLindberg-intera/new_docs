-- FUNCTION: public."fn_test_stats_by_year_outside_inner_CR"()

-- DROP FUNCTION public."fn_test_stats_by_year_outside_inner_CR"();

CREATE OR REPLACE FUNCTION public."fn_test_stats_by_year_outside_inner_CR"(
	)
...
ALTER FUNCTION public."fn_test_stats_by_year_outside_inner_CR"()
    OWNER TO ca;
