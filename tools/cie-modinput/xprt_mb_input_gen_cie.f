...
c          Reads 1943-2018 input file and modifies for the mass balance simulation.
c
...
c
  100 READ(11,"(a1024)",END=9991) line1
      ...
      GOTO 100
c
  200 WRITE(20,"(a28,a1,i4,a1,i4,a2)") 
     >    'CIE Mass Balance Simulation ',
     >    '(',1943,'-',nyrend,'),'
c
...
c
     ...
     >    nyrend,',year,1.0E-08,year,1.0,year,1.25,16,1.0E-6,'
