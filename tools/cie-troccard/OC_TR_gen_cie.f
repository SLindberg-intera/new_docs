c       ************************ PROGRAM OC_TR_gen_cie.f ****************************
c          Generate Output Control card for the CIE transport simulations.
c
...
c
      READ(args(1),"(a80)") infile3
      WRITE(*,*) ' Plot times file = ',infile3
c
      outfile1="cie_Output_Control.dat"
      outfile2="cie_Mass_Balance_Output_Control.dat"
c
...
c
     ...
     >  '-----------------------'
      WRITE(21,"(a)") '#'
      WRITE(21,"(a)") 
     >  '# Output Control Card for CIE transport simulation'
      WRITE(21,"(a)") '#'
      WRITE(21,"(2a)") '#-------------------------------------------',
     >  '-----------------------'
...
c
      ...
      WRITE(21,"(a)") 'Solute Aqueous Conc, U,1/L,'
      WRITE(21,"(a)") 'Solute Integrated Mass, U, ,'
      WRITE(21,"(a)") 'Solute Aqueous Conc, Cr,1/L,'
      WRITE(21,"(a)") 'Solute Integrated Mass, Cr, ,'
      WRITE(21,"(a)") 'Solute Aqueous Conc, NO3,1/L,'
      WRITE(21,"(a)") 'Solute Integrated Mass, NO3, ,'
      WRITE(21,"(a)") 'Solute Aqueous Conc, CN,1/L,'
      WRITE(21,"(a)") 'Solute Integrated Mass, CN, ,'
...
c
     ...
     >  '-----------------------'
      WRITE(22,"(a)") '#'
      WRITE(22,"(2a)") '# Output Control Card for CIE transport mass',
     >  ' balance simulation'
      WRITE(22,"(a)") '#'
      WRITE(22,"(2a)") '#-------------------------------------------',
     >  '-----------------------'
...
c
      ...
      WRITE(22,"(a)") 'Solute Aqueous Conc, U,1/L,'
      WRITE(22,"(a)") 'Solute Integrated Mass, U, ,'
      WRITE(22,"(a)") 'Solute Aqueous Conc, Cr,1/L,'
      WRITE(22,"(a)") 'Solute Integrated Mass, Cr, ,'
      WRITE(22,"(a)") 'Solute Aqueous Conc, NO3,1/L,'
      WRITE(22,"(a)") 'Solute Integrated Mass, NO3, ,'
      WRITE(22,"(a)") 'Solute Aqueous Conc, CN,1/L,'
      WRITE(22,"(a)") 'Solute Integrated Mass, CN, ,'
